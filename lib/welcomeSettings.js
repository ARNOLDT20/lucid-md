...
module.exports = {
    getAll() { return read() },
    get(groupId) { const s = read(); return s[groupId] || { welcome: !!config.DEFAULT_WELCOME_ON_DEPLOY, goodbye: !!config.DEFAULT_GOODBYE_ON_DEPLOY, welcomeMsg: null, goodbyeMsg: null } },
